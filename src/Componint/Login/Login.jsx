    ...
    <>
     <div className="container mt-3  ">
      ...
      <input
        ...
        : <button disabled={!(form1.isValid || form1.isloding && form1.dirty)} type="submit" className="btn btn-main mt-2 w-50">Login</button>


}
  <hr/>
<Link to={'/forgotPasswords'}>
  <p className="mt-2 text-muted">Forget password..? </p>
  </Link>

  <Link to={'/Contact'}>
  <p className="mt-2 text-muted ">Not a member <span className="text-main">Register</span>   </p>
  </Link>
      </form>
