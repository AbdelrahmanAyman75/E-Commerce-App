...
export default function Contact() {
  ...
  return (
    ...
    <div className="container mt-3 ">
         <form onSubmit={form1.handleSubmit} className="form ">
        ...
        />
        {form1.errors.name && form1.touched.name?<div className="alert alert-danger p mt-1 p-1   ">{form1.errors.name}</div>: ""}
        ...
        />
        {form1.errors.email&& form1.touched.email?<div className="alert alert-danger p mt-1 p-1   ">{form1.errors.email}</div>: ""}
        ...
        />
          ...
          {form1.errors.phone && form1.touched.phone?<div className="alert alert-danger p mt-1 p-1  ">{form1.errors.phone}</div>: ""}
        ...
        />
        {form1.errors.password && form1.touched.password?<div className="alert alert-danger p mt-1 p-1   ">{form1.errors.password}</div>: ""}
        ...
        <input
          ...
          className="form-control mt-2"
        />
        {form1.errors.rePassword && form1.touched.rePassword?<div className="alert alert-danger p mt-1 p-1   ">{form1.errors.rePassword}</div>: ""}
        ...
        : <button disabled={!(form1.isValid || form1.isloding && form1.dirty)} type="submit" className="btn btn-main mt-2 w-50">Register</button>
}
<hr/>
<Link to={'/Login'}>
  <p className="mt-2 text-blue a "> Already have an account ! <span className="text-main"> Login</span></p>
  </Link>
  </form>
    </div>
    </>
